...
const MODULES_TREE: ModuleNode[] = [
  ...
  {
    id: 'aquatone-visual',
    name: 'Aquatone / Screenshots + Relatório Visual',
...
export default function ArchitectureFlow() {
  const [selectedModuleId, setSelectedModuleId] = useState<string>('subfinder-osint');
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mt-4 items-center">
            ...
            <div className="lg:col-span-6 bg-slate-950 p-4 rounded-xl border border-slate-800/80 font-mono text-xs sm:text-sm text-cyan-300 leading-relaxed overflow-x-auto selection:bg-emerald-500 selection:text-slate-950">
              <pre className="text-slate-300 font-mono">
                ...
                <span className="text-slate-600">├── </span><span className="text-cyan-400 hover:underline cursor-pointer" onClick={() => setSelectedModuleId('subfinder-osint')}>Subfinder/OSINT</span>{'\n'}
                <span className="text-slate-600">├── </span><span className="text-emerald-400 hover:underline cursor-pointer" onClick={() => setSelectedModuleId('httpx-probing')}>httpx/probing</span>{'\n'}
                <span className="text-slate-600">├── </span><span className="text-purple-400 hover:underline cursor-pointer" onClick={() => setSelectedModuleId('katana-crawling')}>Katana/crawling</span>{'\n'}
                <span className="text-slate-600">├── </span><span className="text-amber-400 hover:underline cursor-pointer" onClick={() => setSelectedModuleId('aquatone-visual')}>Aquatone/screenshots + relatório visual</span>{'\n'}
                <span className="text-slate-600">├── </span><span className="text-rose-400 hover:underline cursor-pointer" onClick={() => setSelectedModuleId('nuclei-rules')}>Nuclei/rules</span>{'\n'}
