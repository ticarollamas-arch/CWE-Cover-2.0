...
# 5. (Opcional) Instalar Nuclei para validação ativa
...
sudo apt update && sudo apt install -y python3 python3-pip python3-venv git curl wget golang-go
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-slate-400 text-sm mt-1 max-w-2xl">
              Documento completo formatado para repositórios GitHub com badges, instalação de todas as dependências (Linux, Termux, Go, Nuclei) e automação de agentes de IA com <strong className="text-slate-200">CrewAI</strong>.
            </p>
          </div>
