        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 border-b border-slate-800 pb-8">
          <div>
            ...
            <h2 className="text-3xl font-extrabold text-slate-100 tracking-tight">
              Documentação Oficial do cwe-discover
            </h2>
            <p className="text-slate-400 text-sm mt-1 max-w-2xl">
              Mais de 50 páginas de documentação técnica, parâmetros de crawling, instalação de dependências, integração com OWASP ZAP, Nuclei e automação de enxame de agentes com <strong className="text-slate-200">CrewAI</strong>.
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8">
          <div className="relative flex-1">
            ...
            <input
              ...
              placeholder="Pesquisar em todos os 26 capítulos (ex: nucleI, delay, cwe-200, zap, flags)..."
