...
export const CHAPTERS_DATA: Chapter[] = [
  {
    ...
    content: [
      ...
      '🧠 Filosofia Central: a ferramenta opera prioritariamente de forma passiva e analítica (sem disparar injeções cegas ou agressivas). Isso é uma decisão arquitetural de design: segurança, discrição e zero risco de derrubar serviços de produção. Para validação ativa estruturada, utilize o motor declarativo de regras e o pipeline de validação diferencial autoral.'
    ],
    tips: [
...
# com status 200.`
  ...
  {
    id: 24,
    slug: 'arquitetura-motores-nativos',
    title: '24. Arquitetura dos Motores Nativos de Reconhecimento',
    category: 'integracoes',
    summary: 'Estrutura e funcionamento dos 17 motores nativos do Cyber Hunter Lab.',
    content: [
      '• Motor 01 (HTTP Base Prober): Sondagem estruturada de protocolos, códigos de resposta e cabeçalhos de segurança.',
      '• Motor 02 (Passive Surface DNS): Resolução de zonas e mapeamento de hosts sem tráfego invasivo.',
      '• Motor 03 (DOM Crawler & Route Mapper): Rastreamento de links, rotas internas e parâmetros de entrada.',
      '• Motor 04 (Sensitive File & Artifact Vault): Verificação heurística de artefatos de configuração e arquivos de ambiente.',
      '• Motor 05 (Session & Token Inspector): Análise passiva de flags de cookies, atributos SameSite e tokens de formulário.',
      '• Motor 06 (Declarative Rule Matcher): Motor de regras declarativas para correlação determinística de CWEs.'
    ],
    codeSnippets: [
      {
        language: 'bash',
        caption: 'Executando os motores combinados nativamente',
        code: `# Executar o pipeline de motores nativos com saída estruturada
python cwe_discover.py -u https://alvo-autorizado.com --i-have-authorization --format json -o surface_data.json`
      }
    ]
  },
  {
...
self.session.headers.update({
  ...
  {
    id: 26,
    slug: 'execucao-mobile-termux',
    title: '26. Execução e Visualização Móvel no Termux',
    category: 'integracoes',
    summary: 'Configuração completa e renderização de relatórios executivos no Android (Termux).',
    content: [
      'O Cyber Hunter Lab foi desenvolvido com suporte nativo de primeira classe para ambientes Android via Termux.',
      'Com consumo ultrabaixo de memória e bateria, o pesquisador pode executar varreduras completas e abrir relatórios HTML formatados diretamente no navegador do smartphone com o utilitário termux-open.'
    ],
    codeSnippets: [
      {
        language: 'bash',
        caption: 'Fluxo móvel completo no Termux',
        code: `# 1. Executar a varredura com geração de relatório HTML
python cwe_discover.py -u https://alvo-autorizado.com --i-have-authorization --format html -o relatorio_mobile.html

# 2. Visualizar diretamente no navegador do smartphone
termux-open relatorio_mobile.html`
      }
    ],
    tips: [
      'Você também pode exportar os relatórios em formato JSON (--format json) para processamento em outros scripts.'
    ]
  },
  {
    id: 27,
    slug: 'instalacao-completa-dependencias',
    title: '27. Instalação Completa do Ambiente (Linux, Termux & Python)',
    category: 'fundamentos',
    summary: 'Tutorial universal para configurar o ambiente do Cyber Hunter Lab em qualquer sistema operacional.',
    content: [
      'Para usufruir de 100% dos recursos nativos do Cyber Hunter Lab (crawler assíncrono, parser BeautifulSoup4 e relatórios multiformato), siga o checklist de instalação para sua plataforma.',
