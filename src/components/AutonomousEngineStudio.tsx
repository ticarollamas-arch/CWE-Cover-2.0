        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-3 sm:gap-4 mb-6 sm:mb-8">
          <div>
            <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/30 text-[11px] sm:text-xs font-mono text-cyan-400 mb-2">
              ...
              <span>SUITE 100% NATIVA • MOTORES INTEGRADOS EM PYTHON PURO</span>
            </div>
            <h2 className="text-xl sm:text-3xl font-extrabold text-slate-100 tracking-tight font-mono">
              Arquitetura Autônoma com Motores Próprios
            </h2>
            <p className="text-slate-400 text-xs sm:text-sm mt-1 max-w-3xl">
              Plataforma autoral com múltiplos motores especializados rodando em Python puro assíncrono, garantindo alta performance, precisão forense e validação determinística sem dependências externas.
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 mb-6">
          ...
          >
            ...
            <div>
              ...
              <div className="text-[10px] sm:text-xs text-slate-400 truncate">OSINT & CT Logs</div>
            </div>
          </button>
          ...
          >
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-[10px] font-mono px-1.5 py-0.5 rounded bg-emerald-500/20 text-emerald-300 font-bold">PROBE</span>
            </div>
            <div>
              <div className="font-bold text-xs sm:text-sm text-slate-100">Prober & Tech</div>
              <div className="text-[10px] sm:text-xs text-slate-400 truncate">Status & Headers</div>
            </div>
          </button>
          ...
          >
            ...
            <div>
              ...
              <div className="text-[10px] sm:text-xs text-slate-400 truncate">Matchers & CWE</div>
            </div>
          </button>
          ...
          >
            ...
            <div>
              ...
              <div className="text-[10px] sm:text-xs text-slate-400 truncate">DOM & JS AST</div>
            </div>
          </button>
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 pb-4 border-b border-slate-800">
                <div>
                  <h3 className="text-base sm:text-lg font-bold text-slate-100 font-mono flex items-center gap-2">
                    <Globe className="w-4 h-4 text-cyan-400" />
                    <span>Motor Nativo de Descoberta de Subdomínios & Superfície</span>
                  </h3>
          ...
          {activeModule === 'probe' && (
            <div className="space-y-5">
              <div className="pb-4 border-b border-slate-800">
                <h3 className="text-base sm:text-lg font-bold text-slate-100 font-mono flex items-center gap-2">
                  <Zap className="w-4 h-4 text-emerald-400" />
                  <span>Motor de Análise HTTP & Fingerprinting de Tecnologias</span>
                </h3>
                <p className="text-xs text-slate-400 mt-0.5">
          ...
          {activeModule === 'rules' && (
            <div className="space-y-5">
              <div className="pb-4 border-b border-slate-800">
                <h3 className="text-base sm:text-lg font-bold text-slate-100 font-mono flex items-center gap-2">
                  <Sliders className="w-4 h-4 text-amber-400" />
                  <span>Motor Declarativo de Regras & Matchers CWE</span>
                </h3>
                <p className="text-xs text-slate-400 mt-0.5">
          ...
          {activeModule === 'crawler' && (
            <div className="space-y-5">
              <div className="pb-4 border-b border-slate-800">
                <h3 className="text-base sm:text-lg font-bold text-slate-100 font-mono flex items-center gap-2">
                  <Code className="w-4 h-4 text-purple-400" />
                  <span>Motor de Rastreamento Web, Scripts JS & Parâmetros</span>
                </h3>
                <p className="text-xs text-slate-400 mt-0.5">
